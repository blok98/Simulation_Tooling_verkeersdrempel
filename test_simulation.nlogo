...
to reset-data
  ...
  print deaths / runs
  print ""
  ifelse distance_to_person-gui < 8[
    set distance_to_person-gui distance_to_person-gui + 1][
    set distance_to_person-gui 2 set speedborder_speedbump-gui speedborder_speedbump-gui - 10]
  clear-globals
end
...
to go
  ;; stops the simulation if all scenarios are tested
  if speedborder_speedbump-gui < 10 [stop]
